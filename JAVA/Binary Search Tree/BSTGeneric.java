...
public class BSTGeneric<E extends Comparable<E>> implements Iterable<E> {
    ...
    public BSTGeneric<E> leftSubTree() {
        return new BSTGeneric<E>(getRoot().getLeft());
    }

    public BSTGeneric<E> rightSubTree() {
        return new BSTGeneric<E>(getRoot().getRight());
    }

    public BSTGeneric<E> getSuperTree() {
        Node<E> temp = getRoot();
        while(temp.getParent() != null)
            temp = temp.getParent();
        return new BSTGeneric<E>(temp);
    }
